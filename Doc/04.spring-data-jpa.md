...
在application.properties 中配置：数据库连接信息（如使用嵌入式数据库则不需要）、自动创建表结构的设置，例如使用mysql的情况如下：
...
[JPA文档](http://docs.spring.io/spring-data/data-jpa/docs/current/api/)

[项目源码](../spring-data-jpa)